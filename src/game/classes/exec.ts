...
export const SKILL_EXEC: Record<string, ExecProfile> = {
  ...
  whirlwind: { kind: 'arc', damageMult: 1.4, damageType: 'physical', cooldown: 1.2, radius: 2.3 },
  ...
  blizzard: { kind: 'aoe', damageMult: 1.9, damageType: 'cold', cooldown: 2.6, missileKind: 'iceball', radius: 3 },
  ...
  inferno: { kind: 'aoe', damageMult: 0.8, damageType: 'fire', cooldown: 0.5, missileKind: 'fireball', radius: 2.5 },
  fire_ball: { kind: 'aoe', damageMult: 1.8, damageType: 'fire', cooldown: 1.0, missileKind: 'fireball', radius: 2.5 },
  fire_wall: { kind: 'aoe', damageMult: 1.6, damageType: 'fire', cooldown: 2.0, missileKind: 'fireball', radius: 3 },
  enchant: { kind: 'shout', damageMult: 0, damageType: 'fire', cooldown: 12, duration: 10 },
  meteor: { kind: 'aoe', damageMult: 2.4, damageType: 'fire', cooldown: 3.2, missileKind: 'fireball', radius: 3 },
